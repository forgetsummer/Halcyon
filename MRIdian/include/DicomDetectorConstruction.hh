...
//     virtual G4VPhysicalVolume* Construct();
      G4VPhysicalVolume* Construct(); // use this function to build the geometry, it is worth noting that here we do not use virtual function
    // trigger the construction of the geometry
    
     G4VPhysicalVolume*  GetWorldPhysicalVolume(){return fWorld_phys;};
     G4LogicalVolume* GetWorldLogicalVolume(){return fWorld_logic;};
     
    G4VPhysicalVolume*  GetContainerPhysicalVolume(){return fContainer_phys;};
     G4LogicalVolume* GetContainerLogicalVolume(){return fContainer_logic;};
     
     std::string PrintTest(){return "TEST !!!";};
     
     void SetDICOMFilesFolderPath(G4String filepath);

// protected: // the original version this is protected.
  ...
  virtual void ConstructPhantom() = 0;
    ...
    G4ThreeVector GetVoxelNumberXYZ();
    G4ThreeVector GetVoxelDimension();
    G4ThreeVector GetVoxelDimMinXYZ();
    G4ThreeVector GetVoxelDimMaxXYZ();
