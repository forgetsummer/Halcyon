...
{
    G4cout << "This is the constructor of DicomRegularDetectorConstruction" << G4endl;
}
...
void DicomRegularDetectorConstruction::ConstructPhantom()
{
 ...
 G4cout<<"Implementation of ConstructPhantom in DicomRegularDetectorConstruction"<<G4endl;
#ifdef G4VERBOSE
  ...
  //----- Set voxel dimensions
    G4cout<<"The voxel dimensions are : "<<fVoxelHalfDimX<<" , "<<fVoxelHalfDimY<<" , "<< 
    fVoxelHalfDimZ<<G4endl;
...
//     /// here we try to check the overlap
//    G4bool check =  phantom_phys->CheckOverlaps(1000, 0.,
//                          true, 1);
//    
//    G4cout<<"the overlap checking is "<<check<<G4endl;
