...
//     G4cout<<"finish ReadColourData in DicomNestedPhantomParameterisation "<<G4endl;
//     exit(0);
//     
...
{
//     G4cout<<"get heere ComputeMaterial"<<G4endl;
//     exit(0);
...
//     matIndex = 5; // here we can try to modify the material types, RL
...
// 	   G4cout<<"the G4LogicalVolume is "<<physVol->GetLogicalVolume()->GetName()<<G4endl;
...
//    G4cout<<"copyID "<<copyID<<" matIndex "<<matIndex<<" mat "<<mate->GetName()<<G4endl;
//    ofstream file_index;
//    file_index.open("ctindex.csv",std::ios_base::app);
//    file_index<<copyID<<","<<matIndex<<G4endl;
