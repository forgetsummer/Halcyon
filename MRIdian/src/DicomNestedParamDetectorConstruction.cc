...
{
  G4cout<<"Implementation of ConstructPhantom in DicomNestedParamDetectorConstruction"<<G4endl;
//   exit(0);
#ifdef G4VERBOSE
    G4cout << "DicomNestedParamDetectorConstruction::ConstructPhantom " 
    << G4endl;
...
//     G4cout<<"fNVoxelX = "<<fNVoxelX<<" fNVoxelY = "<<fNVoxelY<<" fNVoxelZ = "<<fNVoxelZ<<G4endl;
//     G4cout<<"get here in DicomNestedParamDetectorConstruction "<<G4endl;
//     exit(0);
